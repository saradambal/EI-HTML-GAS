...
try
{
  ...
  function CERM_ENTRY_processFormSubmit(ERM_ENTRY_details)
  {
    ...
    if(ERM_ENTRY_guests=="")
    { var mailguests="";ERM_ENTRY_guests=null;}else{var mailguests=ERM_ENTRY_guests;ERM_ENTRY_guests=eilib.ConvertSpclCharString(ERM_ENTRY_guests)}
    var ERM_ENTRY_age=ERM_ENTRY_details.CERM_ENTRY_tb_age;
    if(ERM_ENTRY_age=="")
    { var mailage=ERM_ENTRY_age;ERM_ENTRY_age=null;}else{mailage=ERM_ENTRY_age;ERM_ENTRY_age=eilib.ConvertSpclCharString(ERM_ENTRY_age)}
    var ERM_ENTRY_contact=ERM_ENTRY_details.CERM_ENTRY_tb_contact;
    if(ERM_ENTRY_contact=="")
    { ERM_ENTRY_contact=null;}
    ...
    if(ERM_ENTRY_occupation1=="OTHERS")
    {
      var dataarray=[ERM_ENTRY_customername,ERM_ENTRY_rent,ERM_ENTRY_moving_date,mailminimummovedate,ERM_ENTRY_occupation,nationality,mailguests,mailage,ERM_ENTRY_contact,ERM_ENTRY_mailid,mailERM_ENTRY_comments];
    }
    else
    {
      var dataarray=[ERM_ENTRY_customername,ERM_ENTRY_rent,ERM_ENTRY_moving_date,mailminimummovedate,ERM_ENTRY_occupation1,nationality,mailguests,mailage,ERM_ENTRY_contact,ERM_ENTRY_mailid,mailERM_ENTRY_comments];
    }
