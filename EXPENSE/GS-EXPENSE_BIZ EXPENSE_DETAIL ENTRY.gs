...
//<!--DONE BY:PUNITHA
//VER 1.6 -SD:10/10/2014 ED:10/10/2014,TRACKER NO:479,1.added script to hide preloader after menu n form loads,2.changed preloader n msgbox position
//<!--DONE BY:SARADAMBAL
//VER 1.5 -SD:18/08/2014 ED:18/08/2014,TRACKER NO:479,updated new links,implemented autogrow,rollback if any issue in calendar or sp,checked sp
...
try{
  ...
  {
    var BDTL_INPUT_conn =eilib.db_GetConnection();
    var  BDTL_INPUT_getDate= eilib.GetUnitSdEdate(BDTL_INPUT_conn,BDTL_INPUT_unitno);
    BDTL_INPUT_conn.close();
  ...
  function BDTL_INPUT_save(BDTL_INPUT_form_biz_detail)
  {
    try{
      ...
      BDTL_INPUT_conn.rollback();
      eilib.StarHubUnit_DeleteCalEvent(BDTL_INPUT_unitnoaircon,calenderIDcode,BDTL_INPUT_starhub_cablestartdate_shtime,BDTL_INPUT_sh_starttime,BDTL_INPUT_sh_endtime,BDTL_INPUT_starhub_cableenddate_shtime,BDTL_INPUT_sh_starttime,BDTL_INPUT_sh_endtime,'CABLE')
      eilib.StarHubUnit_DeleteCalEvent(BDTL_INPUT_unitnoaircon,calenderIDcode,BDTL_INPUT_starhub_internetstartdate_shtime,BDTL_INPUT_sh_starttime,BDTL_INPUT_sh_endtime,BDTL_INPUT_starhub_internetenddate_shtime,BDTL_INPUT_sh_starttime,BDTL_INPUT_sh_endtime,'INTERNET')
      BDTL_INPUT_conn.close() 
